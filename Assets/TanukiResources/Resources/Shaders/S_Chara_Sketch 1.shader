...
Shader "Shader Forge/hatching" {
    Properties {
        ...
        _BaseTexture02 ("Base Texture 02", 2D) = "white" {}
        _AlphaTexture ("Alpha Texture", 2D) = "white" {}
        _MaskEmissive ("Mask Emissive", 2D) = "white" {}
    ...
    SubShader {
        ...
        Pass {
            ...
            uniform sampler2D _BaseTexture02; uniform float4 _BaseTexture02_ST;
            uniform sampler2D _AlphaTexture; uniform float4 _AlphaTexture_ST;
            uniform sampler2D _MaskEmissive; uniform float4 _MaskEmissive_ST;
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float3 _BaseTexture01_var = UnpackNormal(tex2D(_BaseTexture01,TRANSFORM_TEX(i.uv0, _BaseTexture01)));
...
////// Emissive:
                float4 _MaskEmissive_var = tex2D(_MaskEmissive,TRANSFORM_TEX(i.uv0, _MaskEmissive));
                float3 emissive = (_MaskEmissive_var.a*_MaskColor.rgb);
                ...
                float4 _BaseTexture02_var = tex2D(_BaseTexture02,TRANSFORM_TEX(i.uv0, _BaseTexture02));
                float3 finalColor = emissive + saturate(( lerp(_BaseTexture02_var.rgb,_ShadowColor.rgb,(floor(node_4818 * _ShadowEffects) / (_ShadowEffects - 1)*node_4845)) > 0.5 ? (1.0-(1.0-2.0*(lerp(_BaseTexture02_var.rgb,_ShadowColor.rgb,(floor(node_4818 * _ShadowEffects) / (_ShadowEffects - 1)*node_4845))-0.5))*(1.0-lerp(_Teinte.rgb,_ShadowColor.rgb,(step(node_8652,smoothstep( node_5833, step(node_5452,node_8652), node_4818 ))*node_4845*step(node_8652,smoothstep( node_5833, step(node_5452,node_8652), node_4818 )))))) : (2.0*lerp(_BaseTexture02_var.rgb,_ShadowColor.rgb,(floor(node_4818 * _ShadowEffects) / (_ShadowEffects - 1)*node_4845))*lerp(_Teinte.rgb,_ShadowColor.rgb,(step(node_8652,smoothstep( node_5833, step(node_5452,node_8652), node_4818 ))*node_4845*step(node_8652,smoothstep( node_5833, step(node_5452,node_8652), node_4818 ))))) ));
...
////// Lighting:
                ...
                float node_4845 = step(_ShadowSize,attenuation);
                float4 _BaseTexture02_var = tex2D(_BaseTexture02,TRANSFORM_TEX(i.uv0, _BaseTexture02));
                float3 finalColor = saturate(( lerp(_BaseTexture02_var.rgb,_ShadowColor.rgb,(floor(node_4818 * _ShadowEffects) / (_ShadowEffects - 1)*node_4845)) > 0.5 ? (1.0-(1.0-2.0*(lerp(_BaseTexture02_var.rgb,_ShadowColor.rgb,(floor(node_4818 * _ShadowEffects) / (_ShadowEffects - 1)*node_4845))-0.5))*(1.0-lerp(_Teinte.rgb,_ShadowColor.rgb,(step(node_8652,smoothstep( node_5833, step(node_5452,node_8652), node_4818 ))*node_4845*step(node_8652,smoothstep( node_5833, step(node_5452,node_8652), node_4818 )))))) : (2.0*lerp(_BaseTexture02_var.rgb,_ShadowColor.rgb,(floor(node_4818 * _ShadowEffects) / (_ShadowEffects - 1)*node_4845))*lerp(_Teinte.rgb,_ShadowColor.rgb,(step(node_8652,smoothstep( node_5833, step(node_5452,node_8652), node_4818 ))*node_4845*step(node_8652,smoothstep( node_5833, step(node_5452,node_8652), node_4818 ))))) ));
