...
Shader "Shader Forge/hatching" {
    Properties {
        ...
        _AlphaTextureDiffuse ("Alpha Texture Diffuse", 2D) = "white" {}
    ...
    SubShader {
        ...
        Pass {
            ...
            uniform sampler2D _AlphaTextureDiffuse; uniform float4 _AlphaTextureDiffuse_ST;
            struct VertexInput {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : COLOR {
                ...
                float4 _AlphaTextureDiffuse_var = tex2D(_AlphaTextureDiffuse,TRANSFORM_TEX(i.uv0, _AlphaTextureDiffuse));
                clip(_AlphaTextureDiffuse_var.a - 0.5);
